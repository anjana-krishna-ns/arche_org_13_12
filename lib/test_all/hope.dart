  ...
  void writeData() async {
    ...
    try {
      final response = await http.post(
        Uri.parse(url),
        body: json.encode({"fname": fname,"lname":lname,"phone": phone,"email": email,"password": password,"confirmPassword": confirmPassword,}),
      );
    } catch (error) {
      throw error;
    }}
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  TextFormField(
                    decoration: InputDecoration(icon: Icon(Icons.person),hintText: "Enter first name"),
                    validator: (value){
                  ...
                  TextFormField(
                    decoration: InputDecoration(icon: Icon(Icons.person),hintText: "Enter last name"),
                    validator: (value){
                      if(value!.isEmpty ||!RegExp(r'^[a-z A-Z]+$').hasMatch(value)){
                        return "Enter Valid Name";
                      }
                    ...
                    decoration: InputDecoration(icon: Icon(Icons.phone),hintText: "Enter Phone Number"),
                    validator: (value) {
                      if (value!.isEmpty) {
                    ...
                    decoration: InputDecoration(icon: Icon(Icons.mail),hintText: "Enter Email"),validator: (valuemail) {
                    ...
                    decoration: InputDecoration(icon: Icon(Icons.password),hintText: "Enter Confirm Password"),
